...
/// Legacy story reader placeholder pages (not wired to [StoryRepo] episodes).
class _StoryPageStub {
  final String narration;
  final String footer;
  const _StoryPageStub({required this.narration, required this.footer});
}

const List<_StoryPageStub> _kDemoStoryPages = [
  _StoryPageStub(
    narration: 'やまだ は かさ を わすれました。',
    footer: 'つぎの ページへ。',
  ),
  _StoryPageStub(
    narration: 'あやな は ともだちに ききました。',
    footer: 'おわり。',
  ),
];
            ...
            child: PageView.builder(
              ...
              itemBuilder: (_, i) => ListView(
                ...
                children: [
                  ...
                  const _Dialog(
                      speaker: 'AYANA', text: 'いっしょに いきますか。', right: true),
                  const SizedBox(height: 8),
        ...
        children: [
          ...
          FloatingActionButton.extended(
            ...
            onPressed: () => Navigator.push(
              context,
              MaterialPageRoute(
                builder: (_) => LearnHubScreen(
                  contentId: widget.story.id,
                  storyTitle: widget.story.title,
                  level: widget.story.jlptLevel,
                  category: widget.story.category?.displayName,
                  coverImageUrl: widget.story.coverUrl,
