...
class OneShortPaperCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final imgPath = hasCategory
        ? assetForCategory(data.category)
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          ...
                          color: data.title.isEmpty
                              ? Colors.grey.shade400
                              : Colors.black87,
                          fontStyle: data.title.isEmpty
                              ? FontStyle.italic
                              : FontStyle.normal,
                          fontFamilyFallback: const [
                            'Noto Sans CJK JP',
                        ...
                        child: Align(
                          ...
                          child: data.context.isEmpty
                              ...
                              : fadingClampedText(
                                  context,
                                  text: data.context,
                                  maxLines: maxContextLines(context,
                                      locale:
                  ...
                  children: [
                    ...
                    Expanded(
                      child: SingleChildScrollView(
                        // always safe for very long texts
                        child: ExpandableText(
                          data.context,
                          trimLines: isCJK(Localizations.maybeLocaleOf(context))
                              ? 8
                              : 6,
                          style: bodyStyle(context),
                        ),
