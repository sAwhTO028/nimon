...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  List<CommunityCollection> _getCommunityCollections() {
    // Demo community collections data
    return [
      CommunityCollection(
        id: 'community_1',
        title: 'Myanmar Hits',
        meta: 'by Community Writers',
        ...
        episodes: [
          Episode(
            ...
            thumbnailUrl: 'https://images.unsplash.com/photo-1519638399535-1b036603ac77?w=200',
            blocks: [
              EpisodeBlock(
                type: BlockType.narration,
                text: 'In the heart of Yangon, the golden pagoda shimmered...',
              ),
            ],
          ),
          Episode(
            ...
            storyId: 'community_1',
            index: 2,
            title: 'Monk\'s Journey',
            thumbnailUrl: 'https://images.unsplash.com/photo-1519638399535-1b036603ac77?w=200',
            blocks: [
              EpisodeBlock(
                type: BlockType.narration,
                text: 'The young monk walked through the ancient temple...',
              ),
            ],
          ),
          Episode(
            ...
            blocks: [
              EpisodeBlock(
                type: BlockType.narration,
                text: 'The bustling market was alive with stories...',
              ),
            ],
          ),
        ],
        ...
        episodes: [
          Episode(
            ...
            blocks: [
              EpisodeBlock(
                type: BlockType.narration,
                text: 'The cherry blossoms bloomed across Tokyo...',
              ),
            ],
          ),
          Episode(
            ...
            blocks: [
              EpisodeBlock(
                type: BlockType.narration,
                text: 'The bullet train raced through the countryside...',
              ),
            ],
          ),
          Episode(
            ...
            blocks: [
              EpisodeBlock(
                type: BlockType.narration,
                text: 'The temple bells rang across the ancient city...',
              ),
            ],
          ),
        ],
      ...
      CommunityCollection(
        id: 'community_3',
        title: 'Korean Dreams',
        meta: 'by K-Drama Fans',
        coverUrl: 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=800',
        episodes: [
          Episode(
            id: 'comm_ep_7',
            storyId: 'community_3',
            ...
            blocks: [
              EpisodeBlock(
                type: BlockType.narration,
                text: 'The neon lights of Seoul illuminated the night...',
              ),
            ],
          ),
          Episode(
            ...
            blocks: [
              EpisodeBlock(
                type: BlockType.narration,
                text: 'Two hearts met under the cherry blossoms...',
              ),
            ],
          ),
          Episode(
            ...
            blocks: [
              EpisodeBlock(
                type: BlockType.narration,
                text: 'The street food vendors prepared their specialties...',
              ),
            ],
          ),
        ],
  ...
  Widget _fromTheCommunitySection() {
    final communities = _getCommunityCollections();
    ...
    return Column(
      children: [
        ...
        Padding(
          ...
          child: Row(
            children: [
              ...
              const Spacer(),
              // "See all" button - Material 3 style
              Material(
        ...
        // Horizontal carousel - Material 3 style
        SizedBox(
          height: 330, // Fixed height to prevent overflow
          child: ListView.separated(
            scrollDirection: Axis.horizontal,
            ...
            itemBuilder: (context, index) {
              ...
              return SizedBox(
                ...
                child: CommunityCard(
                  community: community,
                  onTap: () {
                    // Navigate to community collection detail
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text('Opening ${community.title} collection...'),
                        action: SnackBarAction(
