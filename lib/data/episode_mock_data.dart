...
/// This creates multiple pages when paginated, ideal for testing the reader UI
const String mockEpisode1Text = '''
...
/// Get mock episode text by episode number
/// Returns the long canonical mock text for Episode 1, or a variation for other episodes
String getMockEpisodeText(int episodeNumber) {
  if (episodeNumber == 1) {
    return mockEpisode1Text;
  }
  // For other episodes, return a variation or the same text
  // In a real app, each episode would have unique content
  return mockEpisode1Text;
}

/// Get a short preview text for episode cards and lists
/// This is used in UI previews, not the full reader
